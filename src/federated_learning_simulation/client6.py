...
DATASET_PATH = '/Users/michalsh/Documents/[03]Nauka/project_topical_research/06-01-24/spectJPG/user06'
...
class Client6(fl.client.NumPyClient):
...
fl.client.start_numpy_client(server_address="[::]:8080", client=Client6())